...
public class TechGigNewYearPartyTest {
    ...
    public void testCase4() {
        ...
        Result maxSum = techGigNewYearParty.findMaxSum();
        assertThat(maxSum.consolidateReverseWay(), is("54") );
    }
    ...
    public void testCase10() {
        ...
        Result maxSum = techGigNewYearParty.findMaxSum();
        assertThat(maxSum.consolidateReverseWay(), is("4444") );
    }
    ...
    public void testCase11() {
        ...
        Result maxSum = techGigNewYearParty.findMaxSum();
        assertThat(maxSum.consolidateReverseWay(), is("89") );
    }
    ...
    public void testCase12() {
        ...
        Result maxSum = techGigNewYearParty.findMaxSum();
        assertThat(maxSum.consolidateReverseWay(), is("-1") );
    }
    ...
    public void testCase13() {
        ...
        Result maxSum = techGigNewYearParty.findMaxSum();
        assertThat(maxSum.consolidateReverseWay(), is("62") );
    }
    ...
    public void testCase15() {
        ...
        Result maxSum = techGigNewYearParty.findMaxSum();
        assertThat(maxSum.consolidateReverseWay(), is("35") );
    }
    ...
    public void testCase16() {
        ...
        Result maxSum = techGigNewYearParty.findMaxSum();
        assertThat(maxSum.consolidateReverseWay(), is("45") );
    }
    ...
    public void testCase17() {
        ...
        Result maxSum = techGigNewYearParty.findMaxSum();
        assertThat(maxSum.consolidateReverseWay(), is("26") );
    }
    ...
    public void testCase20() {
        ...
        Result maxSum = techGigNewYearParty.findMaxSum();
        assertThat(maxSum.consolidateReverseWay(), is("") );
    }
    ...
    public void testCase21()
    {
        ...
        expectedTestCases.forEach(new Consumer<String>() {
            @Override
            public void accept(String s) {
                ...
                TechGigNewYearParty techGigNewYearParty=new TechGigNewYearParty(Arrays.stream(input.split(" "))
                        ...
                        .toArray());
                assertThat(techGigNewYearParty.findMaxSum().consolidateReverseWay(), is(output));
